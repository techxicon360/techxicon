...
const social = [
  {
    id: 1,
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/noorulain000',
    icon: linkedin,
    icon1: linkedin1,
  },
  // {
  //   id: 2,
  //   name: 'Fiver',
  //   url: 'https://www.fiverr.com/noorwebdev11',
  //   icon: facebook,
  //   icon1: facebook1,
  // },
  // {
  ...
  // },
  {
    id: 5,
    name: 'Github',
    url: 'https://github.com/noorul-ain',
    icon: github,
    icon1: github1,
  },
];
...
const technologies = [
  ...
  },
  {
    stack: ['frameworks', 'all'],
    name: 'Chakra UI',
    icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/chakraui/chakraui-plain.svg',
  },
...
const projects = [
  ...
  },
  {
    ...
    tech: ['React', 'Next' , 'Nodejs', 'Mongodb'],
    img: recipeapp,
  ...
  },
  {
    ...
    tech: ['Python', 'Django & DjangoRestframework', 'React'],
    img: trackbudget,

...
const services = [
  {
    ...
    icon: <Image src="/digital.png" alt="Digital Marketing Icon" width={40} height={40} className="mx-auto" />,
  },
  {
    ...
    icon: <Image src="/visual.png" alt="Visual Designing Icon" width={40} height={40} className="mx-auto" />,
  },
  {
    ...
    icon: <Image src="/web.png" alt="Web Development Icon" width={40} height={40} className="mx-auto" />,
  },
  {
    ...
    icon: <Image src="/app.png" alt="App Development Icon" width={40} height={40} className="mx-auto" />,
  },
  {
    title: "SEO Services",
    ...
    icon: <Image src="/seo.png" alt="SEO Services Icon" width={40} height={40} className="mx-auto" />,
  },
  {
    ...
    icon: <Image src="/content.png" alt="Content Writing Icon" width={40} height={40} className="mx-auto" />,
  },
];

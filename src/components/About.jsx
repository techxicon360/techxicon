  ...
  <>
    ...
    <div className={style.para}>
      <motion.p variants={fadeIn('', '', 0.5, 1)} className={style.text}>
        ...
        {' '}
        <a
          href="https://github.com/noorul-ain"
          target="_blank"
        ...
        {' '}
        a passionate software engineer specializing in React and Python . I thrive on delivering state-of-the-art software solutions. When I&apos;m not coding, you&apos;ll find me exploring the fascinating worlds of Math, Movies, and Music.
      </motion.p>
      <motion.p variants={fadeIn('', '', 1, 1)} className={style.text}>
        My journey into software development was anything but ordinary. As a third-year student at GCUF University, I made a bold decision to drop out and pursue my true passion. That led me to Microverse, a remote software development school, where I honed my skills through pair programming and real-world projects. I completed the boot camp with unwavering dedication, amassing over
        {' '}
        <a
          href="https://github.com/noorul-ain/noorul-ain"
          target="_blank"
          className={style.link}
          rel="noreferrer"
        >

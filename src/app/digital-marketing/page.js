...
<>
            ...
            <div className=' p-6 md:p-25 relative'>
                ...
                <div className=' flex items-center p-6 md:p-9 flex-col md:flex-row md:gap-13 gap-5'>
                    ...
                    >
                        <div className=' space-y-2 md:w-full w-full relative'>
                            ...
                            <p className='poppins-400 text-[#494949] text-[14px] font-Poppins leading-relaxed'>From SEO and content marketing to social media management and PPC campaigns, our data-driven approach ensures that every campaign is optimized for maximum impact,helping you reach and engage your target audience effectively.</p>
                    ...
                    <div className='gap-2'>
                        <img src='digital.png' alt='Digital Marketing' className='md:max-w-90 md:max-h-90' />
                    </div>
                </div>
                ...
                <div className='flex flex-col md:flex-row items-center gap-6 md:w-[1138px] h-[auto] relative'>
                    <img src='target.png' alt='Target Icon' className='md:w-[385px] md:h-[400px] object-contain' />
                    <div className='space-y-4'>
                        <h1 className='poppins-500 text-[24px] font-bold font-poppins text-black'>Why Choose TechXicon for Digital Marketing?</h1>
                        <ul className="list-inside text-[#494949] font-semibold space-y-4">
                            <li>
                                <h3 className="poppins-500 font-semibold text-[#000000] text-[17px]">1. Personalized Plans</h3>
                                <p className='poppins-400 text-[#494949] text-[16px] font-normal font-poppins px-3'>
                                    We understand every business is unique, so we create custom digital marketing
                                    plans designed specifically for your goals and audience.
                                </p>
                            </li>

                            <li>
                                <h3 className="poppins-500 font-semibold text-[#000000] text-[17px]">2. Results-Driven Approach</h3>
                                <p className='poppins-400 text-[#494949] text-[16px] font-normal font-poppins px-3'>
                                    We use data and analytics to track your campaigns, make improvements,
                                    and deliver the best results for your investment.
                                </p>
                            </li>
                            <li>
                                <h3 className="poppins-500 font-semibold text-[#000000] text-[17px]">3. Comprehensive Digital Skills</h3>
                                <p className='poppins-400 text-[#494949] text-[16px] font-normal font-poppins px-3'>
                                    From social media to search engines and email marketing, our team knows
                                    how to grow your business on all digital platforms.
                                </p>
                            </li>
                        </ul>
